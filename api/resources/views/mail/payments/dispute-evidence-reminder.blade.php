...
<head>
    ...
    <title>3 days left to respond to dispute — Wayfield</title>
</head>
          ...
          <td style="padding:0 32px 32px;">
            <div style="border-left:4px solid #E94F37;padding-left:16px;margin:0 0 24px;">
              <h1 style="font-family:'Sora',Arial,sans-serif;font-size:22px;font-weight:700;color:#B91C1C;margin:0 0 6px;">
                &#8987; {{ $daysRemaining }} {{ $daysRemaining === 1 ? 'day' : 'days' }} left to respond to dispute
              </h1>
              <p style="font-size:15px;line-height:1.6;margin:0;color:#2E2E2E;">
                The evidence deadline for order <strong>#{{ $order->order_number }}</strong> is
                <strong style="color:#B91C1C;">{{ \Carbon\Carbon::parse($evidenceDueBy)->format('F j, Y') }}</strong>.
                You must submit evidence before then or Stripe will automatically decide against you.
              </p>
            </div>
            ...
            <table width="100%" cellpadding="0" cellspacing="0"
              ...
              <tr style="border-top:1px solid #E5E7EB;background:#FEF2F2;">
                <td style="padding:10px 14px;font-size:14px;font-weight:700;color:#B91C1C;">Evidence deadline</td>
