...
export const metadata: Metadata = {
  title: 'Partners | Wayfield',
  description: 'The Wayfield partner program for agencies and workshop consultants.',
}
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-500 mb-8 leading-relaxed">
          Partner with Wayfield to offer workshop management to your clients.
        </p>
        <Link href="/"
