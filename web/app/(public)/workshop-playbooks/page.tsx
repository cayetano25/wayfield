...
export const metadata: Metadata = {
  title: 'Workshop Playbooks | Wayfield',
  description: 'Proven frameworks and templates for workshop design.',
}

export default function WorkshopPlaybooksPage() {
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-500 mb-8 leading-relaxed">
          Field-tested playbooks for designing and running creative workshops.
        </p>
        <Link href="/"
