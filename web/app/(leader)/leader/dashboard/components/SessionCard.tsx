...
export function SessionCard({ session }: { session: LeaderDashboardSession }) {
  ...
  const windowOpen = session.messaging_window_open ?? session.messaging_window?.is_open ?? false;
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '20px 20px 16px' }}>
        ...
        {/* Workshop name — full text, wraps on narrow viewports */}
        <p
          ...
          <div className="flex items-start gap-2.5">
            ...
            {!locationPresent ? (
              ...
              <div className="flex flex-col gap-0.5">
                {/* Step 2 — same as workshop venue label */}
                {isSameAsVenue && (
                ...
                {/* Step 3 — address text lines (only when address text is present) */}
                {hasAddressText && (
      ...
      >
        ...
        <div className="relative group">
          {windowOpen ? (
            <Link
              href={`/leader/notifications/new?session_id=${session.session_id}`}
            ...
            <>
              <button
                type="button"
                disabled
                className="inline-flex items-center gap-2 font-sans font-semibold rounded-lg cursor-not-allowed"
                style={{
                  fontSize: 13,
                  padding: '10px 16px',
                  minHeight: 44,
              ...
              >
                ...
                >
                  Available 4 hours before session starts
                </div>
              </div>
            </>
          )}
