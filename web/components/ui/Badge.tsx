...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  'session-addon':          'bg-orange-100 text-orange-700',
  'session-hidden':         'bg-sky-100 text-sky-700',
  'session-assigned_only':  'bg-secondary/10 text-secondary',
...
const variantLabels: Partial<Record<BadgeVariant, string>> = {
  ...
  'session-addon':         'Add-On',
  'session-hidden':        'Hidden',
  'session-assigned_only': 'Assigned Only',
};
