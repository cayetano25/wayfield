    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#F5F5F5' }}>
      ...
      >
        <div className="w-full max-w-5xl mx-auto px-4 flex items-center justify-between h-full">
          {/* Logo */}
          <Link href="/leader/dashboard" className="font-heading font-extrabold text-xl shrink-0">
          ...
          <nav className="flex items-center gap-6 h-full">
            <NavLink href="/leader/sessions" label="My Sessions" />
            <NavLink href="/leader/rosters" label="Rosters" />
